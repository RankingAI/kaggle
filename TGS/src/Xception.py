...
class Xception:
    def __init__(self, input_shape, input_tensor, include_top=False, phase='train'):
        ''''''
        self.model = self.get_base_model(include_top= include_top, input_shape= input_shape, input_tensor= input_tensor, phase= phase)

    def get_base_model(self, include_top=True, weights='imagenet',
        ...
        input_shape = img_utils_1._obtain_input_shape(input_shape,
                                          default_size=299,
                                          min_size=71,
